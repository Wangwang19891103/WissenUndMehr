...
+ (LocationDataManager*) instanceNamed:(NSString *)name {
    ...
    @synchronized(self) {
        ...
        if ([_instances objectForKey:name]) {
            ...
            LocationDataManager* newManager = [[LocationDataManager alloc] initWithModelName:name storeName:name location:DataManagerStoreLocationDocuments];
...
+ (LocationDataManager*) instanceInBundleNamed:(NSString *)name {
    ...
    @synchronized(self) {
        ...
        if ([_instances objectForKey:name]) {
            ...
            LocationDataManager* newManager = [[LocationDataManager alloc] initWithModelName:name storeName:name location:DataManagerStoreLocationBundle];
            [_instances setObject:newManager forKey:name];
            return newManager;
        }
    }
